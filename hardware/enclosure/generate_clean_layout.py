#!/usr/bin/env python3
"""
PRISME HARDWARE SCHEMATIC - PROPER ABSOLUTE POSITIONING
The problem: vertically routing from stacked pins.
The solution: Place output components at absolute Y positions that naturally align.
"""
...
with schemdraw.Drawing() as d:
    ...
    M4 = (elm.Ic()
          ...
          .side('R', spacing=2, pad=2, leadlen=2)  # BIGGER spacing on right
    ...
    # =======================================================================
    # RIGHT SIDE - INDICATORS (stacked with good spacing)
    # With RIGHT side spacing=2, pins are ~2 units apart vertically
    # Just go straight right from each pin
    # =======================================================================
...
print("✅ CLEAN SCHEMATIC WITH PROPER RIGHT-SIDE SPACING")
