...
d += elm.Resistor().at((13.5, 10)).right(0.8).label('220Ω', fontsize=7, loc='top')
...
d += elm.Resistor().at((13.5, 8)).right(0.8).label('220Ω', fontsize=7, loc='top')
...
d += elm.Resistor().at((14.5, 4.7)).right(0.8).label('220Ω', fontsize=7, loc='top')
d += elm.LED().right(0.5).label('White', fontsize=7, loc='top')
...
d += elm.Resistor().at((14.5, 3.5)).right(0.8).label('220Ω', fontsize=7, loc='top')
d += elm.LED().right(0.5).label('RGB', fontsize=7, loc='top')
...
d += elm.Resistor().at((14.5, 1.7)).right(0.8).label('220Ω', fontsize=7, loc='top')
d += elm.LED().right(0.5).label('White', fontsize=7, loc='top')
...
d += elm.Resistor().at((14, -0.3)).right(0.8).label('220Ω', fontsize=7, loc='top')
d += elm.LED().right(0.5).label('White', fontsize=7, loc='top')
...
d += elm.Resistor().at((14, -1.6)).right(0.8).label('220Ω', fontsize=7, loc='top')
d += elm.LED().right(0.5).label('White', fontsize=7, loc='top')
...
d += elm.Label().at((0, -4)).label('          220Ω (white LED current limit), 220Ω (RGB LED current limit)', fontsize=8, halign='left')
